...
public:
    ...
    static std::unique_ptr<double_t[]> DoubleArray(int32_t size)
    {
        auto arr = std::make_unique<double_t[]>(size);
    ...
    static glm::mat4 RandomModel(double minScale, double maxScale)
    {
        ...
        glm::mat4 res = glm::rotate(glm::mat4(1.0f), util::toRadians(Double(0.0, 360.0)), vRotation);
